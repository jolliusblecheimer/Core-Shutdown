...
| id | name | where | look |
|---|---|---|---|
| **12** | `runway` | y 24–30, x 4–92 | Dark asphalt, rubber-streaked at both thresholds, centreline dashes as decals |
| **13** | `apron` | y 14–22 and y 32–44 | Paler concrete in slabs, oil stains, expansion joints |
...
| | |
|---|---|
| **Ground** | New id **14** `tunnel` — wet concrete, puddles, tyre-polished centre |
...
| | Sprite | Notes |
|---|---|---|
| **Ground** | `runway`, `apron`, `tunnel` | ids 12, 13, 14 in `buildTilesets()` |
